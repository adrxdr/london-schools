...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Example Academy | 49.2 | 48.5 | 120 | 30 | ≥10 | ≥33% | Hackney | E8 | Academy | State | Co-ed | N/A | comprehensive/non-selective | No extra academic exam noted | Yes | secondary-only | [Map](https://example.test/map) |
